    ...
    if transport == "sse":
        ...
        starlette_app = Starlette(
            ...
            routes=[
                ...
                Route("/tools/onboarding", endpoint=run_onboarding, methods=["GET", "POST"]),
                ...
                Route("/tools/get_croissant_record", endpoint=mcp_croissant_record_endpoint, methods=["GET", "POST"]),
                ...
                Route("/tools/overview", endpoint=run_get_overview, methods=["GET", "POST"]),
                Route("/overview", endpoint=run_get_overview, methods=["GET", "POST"]),
                Route("/tools/overview/datasets", endpoint=run_get_overview_datasets, methods=["GET", "POST"]),
                Route("/overview/datasets", endpoint=run_get_overview_datasets, methods=["GET", "POST"]),
                Route("/tools/search/datasets", endpoint=run_search_datasets, methods=["GET", "POST"]),
